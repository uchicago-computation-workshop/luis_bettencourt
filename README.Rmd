...
<p class=footertext>This week, Luís was kind enough to contribute two papers, one in development and a related publication in PNAS. MACSS students should focus their response on the project in development: <a href="`r paper_link`" >`r title`</a>, since these comments will have greater potential impact. Both papers are available <a href="`r repo_page`"> on Github for review. </a></p>
